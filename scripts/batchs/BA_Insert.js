...
var BS_Insert_1 = require('./BS_Insert');
var exec = require('child_process').exec;
var BA_Insert = (function (_super) {
    __extends(BA_Insert, _super);
    function BA_Insert() {
        _super.apply(this, arguments);
    }
    BA_Insert.prototype.selectData = function (callback) {
    ...
    BA_Insert.prototype.splitData = function (datas) {
        var packets = [];
    ...
    BA_Insert.prototype.createBatchSession = function () {
        return new BS_Insert_1.default();
    };
    return BA_Insert;
}(batch_1.BatchActivity));
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = BA_Insert;
