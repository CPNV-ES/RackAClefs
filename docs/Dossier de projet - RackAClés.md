...
- [Projet Rack à Clés](#projet-rack-à-clés)
    ...
    - [2. Analyse](#2-analyse)
        - [2.1 Cahier des charges détaillé](#21-cahier-des-charges-détaillé)
            ...
            - [2.1.4 Maquette préliminaire](#214-maquette-préliminaire)
        ...
        - [2.2 Stratégie de tests](#22-stratégie-de-tests)
    ...
    - [3. Conception](#3-conception)
        ...
        - [3.3 Définition de la charte graphique](#33-définition-de-la-charte-graphique)
...
![](Plannification.png)
### 2.5 Historique
L'historique est disponible en tout temps sur [le compte github du CPNV](http://github.com/CPNV-ES/RackACles.git)
...
### 7.5 Archive du projet
 Une archive est disponible en tout temps sur [le compte github du CPNV](http://github.com/CPNV-ES/RackACles.git)